...
async def scrape_listing_pages():
    ...
    while True:
        url = f"https://informatics-dz.com/product-category/unite-centrale/page/{page}/?per_page=24"
...
async def main():
    ...
    with open(r"multimedia\informatics\data\informatics_desktop_items.json", "w", encoding="utf-8") as f:
