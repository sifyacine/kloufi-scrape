# main.py - Ouedkniss Emploi Demandes with ProxyManager
import asyncio
import json
import re
import sys
...
# ========================= CONFIG =========================
log = get_logger("main_scraper_emploi_demandes")

TARGET_URL_BASE = "https://www.ouedkniss.com/emploi_demandes/"
...
async def main():
    """Main orchestrator"""
    log.info("Starting Ouedkniss Emploi Demandes scraper")
