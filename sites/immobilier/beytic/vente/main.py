...
async def main():
    vente_total_pages = await get_total_pages("Vente")
    
    print("Vente total pages:", vente_total_pages)
    
    for page_number in range(1, vente_total_pages):
        print(f"Scraping page {page_number}...")
        await scrape_page(page_number, "Vente")
