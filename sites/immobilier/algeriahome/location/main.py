...
async def scrape_listing_pages():
    ...
    while True:
        url = f"https://www.algeriahome.com/a-louer/{page}"
...
async def main():
    ...
    with open(fr"immobilier\algeriahome\data\location\algeriahome_location_properties(225-275).json", "w", encoding="utf-8") as f:
